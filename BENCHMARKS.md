...
|---|---:|---:|---|
| Sustained batched HTTP ingest | 200860 spans/s | >= 50,000 spans/s | PASS |
...
|---|---:|---:|---:|---:|
| Trace by ID | 0.155 ms | 0.296 ms | 0.322 ms | 200 |
| Attribute filter | 50.287 ms | 73.691 ms | 106.044 ms | 100 |
...
- Build: Cargo release profile. Timestamp: Unix 1784618696.
- Machine context: macos/aarch64, 10 available hardware threads.
- Final server stats: `{"bytes_on_disk":327068707,"segment_count":1,"span_count":1000000}`.
