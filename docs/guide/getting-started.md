...
```sh
curl -LO https://github.com/toshish/traza/releases/download/v0.24.1/traza-0.24.1-macos-aarch64.tar.gz
tar xzf traza-0.24.1-macos-aarch64.tar.gz && cd traza-0.24.1-macos-aarch64
```
